        ...
        if ($stmt->num_rows == 1) {
            ...
            if (checkbrute($user_id, $mysqli) == true) {
                ...
                if ($db_password == $password) {
                    ...
                    $now = time();
                    if (!$mysqli->query("INSERT INTO login_attempts(user_id, username, time) 
...
// Cross Site Scripting (XSS) commands
// w3schools talks about htmlspecialchars() function below
