 ...
 */
        ...
        function hb_register_required_plugins() {
            ...
            $plugins           = array(
                ...
                array(
                    ...
                    'force_activation' => false,
                    'force_deactivation' => false,
                    'external_url'       => 'http://downloads.wordpress.org/plugin/contact-form-7.4.1.2.zip'
                ),
                array(
            ...
            $config            = array(
                ...
                'message' => '<p>To make your website load faster only activate plugins you need.<br/>For example, do not activate both Layer Slider and Revolution Slider, because they offer similar features. Choose one of the two sliders.</p>', // Message to output right before the plugins table
                'strings' => array(
    ...
    /* CHECK IF HIGHEND TEMPLATE IMPORTED
    ================================================== */
    ...
    /* RETURN HIGHEND TEMPLATE NAME
    ================================================== */
    function get_hb_template_name() {
        return "blog";
    }
