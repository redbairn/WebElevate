...
class hb_contact_info_widget extends WP_Widget {
	...
	function HB_Contact_Info_Widget() {
		...
		$control_ops = array ();
		/* Create the widget. */
		parent::__construct( 'hb_contact_info_widget', __('[HB-Themes] Contact Info Widget','hbthemes'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<ul>
			...
			<?php if ( !empty( $phone ) ):?><li><i class="hb-moon-phone-2"></i><span><a href="tel:<?php echo $phone; ?>"><?php echo $phone;?></a></span></li><?php endif;?>
