...
<div class="wrap about-wrap hb-alt-wrap">
	<h2><?php _e('Import Highend Demo Templates', 'hbthemes'); ?></h2>
	...
	<div class="hb-row clearfix">
        ...
        <div class="hb-col-3">
            ...
            <div class="bottom-part">
                ...
                <div class="hb-button-holder"><a href="#" data-demo-id="jasper" data-demo-name="Jasper" class="hb-import-template button-primary"><?php _e('Import', 'hbthemes'); ?></a><a href="http://hb-themes.com/demo/jasper" class="button" target="_blank"><?php _e('Live Preview','hbthemes'); ?></a></div>
            </div>
        </div>
